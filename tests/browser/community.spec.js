...
test('chat and announcement controls work on desktop and mobile',async({page})=>{
  ...
  await page.goto('/admin#settings');await expect(page.getByRole('heading',{name:'Password recovery'})).toHaveCount(0);
